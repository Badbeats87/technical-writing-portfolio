...
## What is two-factor authentication? <a name="what-is-two-factor-authentication"></a>
...
## Prerequisite: install an authenticator app <a name="prerequisite-install-an-authenticator-app"></a>
...
## Activate 2FA for your account <a name="activate-2fa-for-your-account"></a>
...
## Log in when 2FA is active <a name="log-in-when-2fa-is-active"></a>

1. Enter your email address and password on the Peopleware login screen and click _Login_{:.doc-button}.
...
### Log in with a backup code <a name="log-in-with-a-backup-code"></a>
...
### Log in without your personal device and backup codes <a name="log-in-without-your-personal-device-and-backup-codes"></a>
...
## Use 2FA on a new personal device <a name="use-2fa-on-a-new-personal-device"></a>
...
## Deactivate 2FA for your account <a name="deactivate-2fa-for-your-account"></a>
